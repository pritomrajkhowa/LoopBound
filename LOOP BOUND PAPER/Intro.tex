...
%Physical resources are the most important component in the execution of a program. 
...
%For example, stack and heap-space bounds are important
%to ensure the reliability of safety-critical systems
...
\yao{It is more important to summarize the technical dimensions and limitations, instead of the "techniques they use''}
